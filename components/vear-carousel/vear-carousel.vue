<template>
	<swiper class="image-container" style="margin-top: 100rpx;" previous-margin="55rpx" next-margin="55rpx" interval="2000" circular   @change="swiperChange">
		<swiper-item :class="currentIndex == index ? 'swiper-item' : 'swiper-item-side'" v-for="(item, index) in imgList" :key="item[urlKey]">
			<view class="main-list-item2 " :class="currentIndex == index ? 'main-list-item' : 'main-list-item-side'" :style="dontFirstAnimation ? 'animation: none;' : ''" @click="click_item(item)">
				...
				<view>
					<view style="font-size: 24rpx;">任务说明:</view>
					<view style="margin-left: 30rpx;margin-top: 6rpx;font-size: 24rpx;height: 110rpx;overflow:hidden">
						&nbsp;&nbsp;{{item.explanation}}
					</view>
				</view>
